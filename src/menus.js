  ...
  const menus = {
    ...
    [localize("&View")]: [
      ...
      MENU_DIVIDER,
      {
        ...
        description: localize(
          "Makes the application take up the entire screen."
        ),
      },
    ],
    [localize("&Image")]: [
    ...
    [localize("E&xtras")]: [
      ...
      },
      {
        ...
        description: localize(
          "Creates an animation from the document history."
        ),
      },
      // {
        ...
        submenu: [
          {
            ...
            description: localize(
              "Starts a new multi-user session from the current document."
            ),
          },
          {
            ...
            description: localize(
              "Starts a new multi-user session from an empty document."
            ),
          },
        ],
      },
      ...
      //   },
      {
        ...
        submenu: available_languages.map((available_language) => ({
          item:
            get_language_emoji(available_language) +
            " " +
            get_language_endonym(available_language),
          action: () => {
      ...
      },
      {
        ...
        speech_recognition: [
          ...
          "toggle speech recognition mode",
          "disable speech recognition",
          "disable speech recognition mode",
          "turn off speech recognition",
          "turn off speech recognition mode",
          "leave speech recognition mode",
          "exit speech recognition mode",
        ],
        checkbox: {
          toggle: () => {
        ...
        checkbox: {
          ...
          check: () => {
            return location.hash.match(
              /vertical-color-box-mode|eye-gaze-mode/i
            );
          },
        },
        enabled: () => {
